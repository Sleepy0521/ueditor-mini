...
(function () {
     ...
     */
    var UOLOAD = window.location.protocol +"//"+ window.location.host;
    window.UMEDITOR_CONFIG = {
        ...
        ,imageUrl: UOLOAD + "/bss-manager/v1/upload/dl/ueditor/file" //图片上传提交地址


        //,imagePath:URL + "bss-manager/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
